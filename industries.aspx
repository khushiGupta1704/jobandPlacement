<%@ Page Title="" Language="C#" MasterPageFile="~/FrontMasterPage.master" AutoEventWireup="true" CodeFile="industries.aspx.cs" Inherits="industries" %>
                        ...
                        <ItemTemplate>
                            <article class="post-modern">
                                <div class="post-header">
                                    <h6 class="text-bold padding-text-15"><%#Eval("name")%></h6>
                                </div>
                                <div class="post-body">
                                ...
                                <div class="offset-top-45">
                                    ...
                                    <ul class="list-marked-bordered offset-top-5">
                                        <asp:Repeater runat="server" ID="Repeater1">
                                            <ItemTemplate>
                                                <li><a href="#"><span><%#Eval("exp1")%></span><span class="text-dusty-gray">(<%#Eval("job_count")%>)</span></a></li>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                    </ul>
                                </div>
