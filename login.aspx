                  ...
                  <div class="block-inner">
                    ...
                    <div class="form-group offset-top-22">
                      <asp:Textbox id="textPassword" runat="server"
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="textPassword" ErrorMessage="*Required"></asp:RequiredFieldValidator>

                    </div>
                    <div class="offset-top-15"><a href="http://localhost:55500/Forget-Password" class="link-default">Forgot your password?</a></div>
                  </div>
                  <div class="offset-top-30 offset-sm-top-60">
                    <asp:Button runat="server" id="submit_button" onclick="submit_button_Click" class="btn btn-primary btn-block" Text="Sign In"></asp:button>
                  </div>
                </div>
              </div>
