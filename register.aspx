    ...
    <section style="background-image: url(front-assets/images/bg-full.jpg);" class="one-screen-page bg-gray-darker bg-image">
        <div class="shell">
            ...
            <div class="range range-sm-center">
                <div class="cell-sm-10 cell-md-8 cell-lg-7" style="margin: 50px">
                        ...
                        <div class="rd-mailform form-modern form-darker offset-top-22">
                            <div class="block-inner">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group offset-top-22">
                                            <asp:DropDownList runat="server" ID="departments" DataValueField="id" DataTextField="title" AutoPostBack="true" OnLoad="departments_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group offset-top-22">
